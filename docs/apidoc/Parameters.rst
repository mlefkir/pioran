...
.. currentmodule:: pioran.parameter_base
...
.. currentmodule:: pioran.parameters
...
On top of the base class is built a :class:`~pioran.parameters.ParametersModel` object. This object inherits from the :class:`equinox.Module` class, which means
