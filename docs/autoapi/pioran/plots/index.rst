...
.. list-table:: Function
   ...
   * - :py:obj:`violin_plots_psd_approx <pioran.plots.violin_plots_psd_approx>`\ (res, ratio, title)
     - Plot the violin plots of the residuals and the ratios of the PSD approximation.
   * - :py:obj:`residuals_quantiles <pioran.plots.residuals_quantiles>`\ (residuals, ratio, f, f_min, f_max, title)
...
.. py:function:: violin_plots_psd_approx(res, ratio, title=True)
...
.. py:function:: residuals_quantiles(residuals, ratio, f, f_min, f_max, title=True)
